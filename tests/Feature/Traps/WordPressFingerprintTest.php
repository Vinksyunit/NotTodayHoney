...
it('GET /wp-admin/wp-login.php includes Link header pointing to wp-json', function (): void {
...
it('GET /wp-admin/wp-login.php includes X-Powered-By header', function (): void {
...
it('GET /wp-admin/wp-login.php does not add fingerprint headers when disabled', function (): void {
