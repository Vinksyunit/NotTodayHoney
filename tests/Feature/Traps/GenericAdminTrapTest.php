...
it('GET /admin/login shows configured title', function () {
...
it('POST /admin/login returns error page with username prefilled on wrong credentials', function () {
...
it('POST /admin/login with known password returns fake dashboard on fake_success behavior', function () {
...
it('POST /admin/login with known password responds with configured login_success_behavior', function () {
